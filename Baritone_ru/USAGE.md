...
Если заметили ошибки в переводе, или имеються какие либо идеи связанные с переводом не больших документаций на GitHub, или локализация программы путём формата `.mo` и `.po` - то пишите мне в [VK](https://vk.com/arkomiko)
# 
